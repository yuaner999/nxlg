...
<div class="table-load">
    <div class="title">
        ...
        <%--<table-btn class="top" ng-click="dels()"><img src="<%=request.getContextPath()%>/images/tabledelete_07.png" />批量删除</table-btn>--%>
            ...
            <input class="tablesearchbtn" type="text" ng-model="crt_type" placeholder="请输入关键字查询..."
                   onkeyup="getSearchStr(this)"/>
            <span class="span_width">使用率：</span>
            <input class="tablesearchbtn" type="text" ng-model="crt_usage" placeholder="请输入关键字查询..."
                   onkeyup="getSearchStr(this)"/>
...
<script>
    ...
    app.controller('ctrl',function  ($scope) {
        ...
        $scope.loadData = function () {
            loading();//加载
            remotecall("crt_usage_load",{
                pageNum:pageNum,
                pageSize:pageSize,
                crt_type:$scope.crt_type,
                crt_usage:$scope.crt_usage
            },function (data) {
                closeLoading();//关闭加载层
