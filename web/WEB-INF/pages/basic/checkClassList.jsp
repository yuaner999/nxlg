...
<div class="table-load">
    ...
    <div class="tablebox_stu a-show a-hide">
        <div class="title">
            <span class="span_width">学号：</span><input class="tablesearchbtn" type="text"  onkeyup="getSearchStr(this)" placeholder="请输入学生学号" ng-model="searchStu.studentNum"/>
            <span class="span_width">姓名：</span><input class="tablesearchbtn" type="text"  onkeyup="getSearchStr(this)" placeholder="请输入学生姓名" ng-model="searchStu.studentName"/>
            <span class="span_width">年级：</span><input class="tablesearchbtn" type="text"  onkeyup="getSearchStr(this)" placeholder="请输入学生年级" ng-model="searchStu.studentGrade"/>
            <span class="span_width">学院：</span><input class="tablesearchbtn" type="text"  onkeyup="getSearchStr(this)" placeholder="请输入学院" ng-model="searchStu.studentCollege"/>
            <span class="span_width">专业：</span><input class="tablesearchbtn" type="text"  onkeyup="getSearchStr(this)" placeholder="请输入专业" ng-model="searchStu.studentMajor"/>
            <span class="span_width">班级：</span><input class="tablesearchbtn" type="text"  onkeyup="getSearchStr(this)" placeholder="请输入学生班级" ng-model="searchStu.studentClass"/>
            <span class="span_width">校区：</span><input class="tablesearchbtn" type="text" ng-model="input.keyword" onkeyup="getSearchStr(this)" placeholder="请输入校区" ng-model="searchStu.studentSchoolAddress"/>
