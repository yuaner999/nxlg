...
<head>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/js/explore_tabexcle/jquery.jqprint-0.3.js"></script>
    <style>
        #MenuForm span {
            width: 135px;
        }
...
<div class="title">
    ...
    <%--</select>--%>
    <span class="span_width">班级名称：</span>
    <select type="text" ng-model="fakeValue" name="fakeValue" class="queryinput" id="teacherCollege">
        <option value="" selected="selected">--请选择--</option>
        <option value="{{class.className}}" ng-repeat="class in newClasses"
                ng-bind="class.className"></option>
    </select>
    <%--<div class="listbox">--%>
        <%--<input style="width:216px;" type="text" ng-model="fakeValue" class="forminput" ng-click="leaveInput()"--%>
               <%--ng-keyup="changeoptions(fakeValue)" placeholder="--全部--"/>--%>
    ...
    <table-btn style="width: 120px;margin-left: 0px;" ng-click="btnExcel()" class="btnExcel">导出预购信息</table-btn>
...
<script>
    ...
    var app = angular.module('app', []).controller('ctrl', function ($scope) {
        ...
        $scope.search = function () {
            loading();
            remotecall("beforeBuying_load", {
                pageNum: pageNum,
                pageSize: pageSize,
                className: $scope.fakeValue
            }, function (data) {
