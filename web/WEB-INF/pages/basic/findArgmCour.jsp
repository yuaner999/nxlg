...
<div class="crlist a-show">
    <div class="title search">
        <input class="tablesearchbtn" ng-model="classroomName" type="text" placeholder="按教室名称进行查询..."/>
        <table-btn id="searchkey" ng-click="loadDataFirst()">搜索</table-btn>
...
<div class="tealist">
    <div class="title search">
        <input class="tablesearchbtn"  ng-model="teacherNumber" type="text" placeholder="按教工工号进行查询..." onkeyup="getSearchStr2(this)"/>
        <table-btn id="searchkey2" ng-click="loadDataSecond()">搜索</table-btn>
        <form class="top_1" method="post" hidden></form>
    </div>
    <div class="tablebox">
        <table class="table">
...
<div class="claroobtn" >
    ...
    <table-btn id="" ng-click="returnPage()">返回</table-btn>
...
<script>
    ...
    app.controller('ctrl',function  ($scope) {
        ...
        $scope.loadUsingClassRoom = function () {
            loading();//加载
            remotecall("basic_classroom_load",{pageNum:pageNum,pageSize:pageSize,classroomName: $scope.classroomName},function (data) {
                closeLoading();
        ...
        $scope.loadTeacher = function () {
            ...
            remotecall("teacherManage_load",{pageNum:pageNum,pageSize:pageSize,teacherNumber:$scope.teacherNumber},function (data) {
                closeLoading();//关闭加载层
...
//            getSearchStr("#searchkey");
        ...
        $scope.returnPage = function(){
            location.href='findArgmCour.form';
        }
