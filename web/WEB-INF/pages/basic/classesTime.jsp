...
<span style="color:red; margin-left: 20px">注：“排课节次”和“不排课节次”中1代表第一大节，依次类推，点击右侧设置可以查看详细的已设置的排课节次信息</span>
<hr>
<!--导航筛选 此页不需要-->
<!--筛选条件按钮组-->
<div class="title">
    ...
    <input class="tablesearchbtn" type="text" ng-model="courseCode" placeholder="请输入课程代码"/>
    <span class="span_width">课程名称：</span>
    <input class="tablesearchbtn" type="text" ng-model="chineseName" placeholder="请输入中文名称"/>
