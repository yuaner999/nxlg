...
<div class="title">
    ...
    <span class="span_width" ng-show="show==0">周次：</span>
         <select type="text" ng-show="show==0" ng-model="week1" name="week1" class="forminput2"/>
    ...
    <span class="span_width" ng-show="show==0">星期:</span>
        <select type="text" ng-show="show==0" ng-model="week2" name="week2" class="forminput2"/>
            <option value="">--请选择--</option>
    ...
    <span class="span_width" ng-show="show==0">节次：</span>
       <select type="text" ng-show="show==0" ng-model="week3" name="week3" class="forminput2"/>
            <option value="">--请选择--</option>
    ...
    <input ng-show="show==3" class="tablesearchbtn" type="text" ng-model="input.keyword" placeholder="请输入关键字进行查询..."
           onkeyup="getSearchStr(this)"/>
    <span class="span_width" ng-show="show==3">周次：</span>
         <select type="text" ng-show="show==3" ng-model="week11" name="week11" class="forminput2"/>
            <option value="">--请选择--</option>
            <option value="1">第1周</option>
            <option value="2">第2周</option>
            <option value="3">第3周</option>
    ...
    <span class="span_width" ng-show="show==3">星期：</span>
        <select type="text" ng-show="show==3" ng-model="week21" name="week21" class="forminput2"/>
            <option value="">--请选择--</option>
            <option value="1">星期一</option>
            <option value="2">星期二</option>
            <option value="3">星期三</option>
    ...
    <span class="span_width" ng-show="show==3">节次：</span>
        <select type="text" ng-show="show==3" ng-model="week31" name="week31" class="forminput2"/>
            <option value="">--请选择--</option>
            <option value="1">第一大节</option>
            <option value="2">第二大节</option>
            <option value="3">第三大节</option>
...
<div class="title">
    ...
    <input  class="tablesearchbtn" type="text" ng-model="tc_class" placeholder="请输入关键字查询..."
            onkeyup="getSearchStr(this)"/>
    <span class="span_width">班级教师：</span>
    <input  class="tablesearchbtn" type="text" ng-model="teacherName" placeholder="请输入关键字查询..."
            onkeyup="getSearchStr(this)"/>
    <table-btn ng-show="show==0" id="search1" ng-click="loadeducateTask()">搜索</table-btn>
    <table-btn ng-show="show==0" ng-click="somestop()"><img src="<%=request.getContextPath()%>/images/tablereject.png"/>批量停课
    </table-btn>
    <table-btn ng-show="show==0" ng-click="showlog1()"><img src="<%=request.getContextPath()%>/images/details.png"
                                                            style="cursor: pointer"/>查看总日志
    </table-btn>
...
<div class="tablebox" ng-show="show=='0'">
    <table class="table">
        ...
        <tr ng-repeat="teachtask in teachtasks">
            ...
            <td>
                <table-btn ng-click="firstadjust(teachtask)">调整</table-btn>
                &nbsp&nbsp
                <table-btn ng-click="firststop(teachtask)">停课</table-btn>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table">
        ...
        <tr ng-repeat="log in logs">
            ...
            <td ng-if="log.type=='调课'">
                <table-btn ng-click="edit(log)">修改</table-btn>
                &nbsp&nbsp
                <table-btn ng-click="dellog(log)">删除</table-btn>
            </td>
            <td ng-if="log.type=='停课'">
                <table-btn ng-click="editthis(log)">修改</table-btn>
                &nbsp&nbsp
                <table-btn ng-click="dellog(log)">删除</table-btn>
            </td>
        </tr>
...
<div class="tablebox" ng-show="show=='1'">
    <table class="table">
        ...
        <tr ng-repeat="adjust in adjustlist">
            ...
            <td>
                <table-btn ng-click="edit(adjust)">修改</table-btn>
                &nbsp&nbsp
...
<div class="tablebox" ng-show="show=='4'">
    <table class="table">
        ...
        <tr ng-repeat="adjust in adjustlist">
            ...
            <td ng-bind="adjust.settime"></td>
            <td>
                <table-btn ng-click="editthis(adjust)">修改</table-btn>
                &nbsp&nbsp
                <table-btn ng-click="del(adjust)">删除</table-btn>
            </td>
        </tr>
        ...
        <div class="row" style="margin-left: 60px">
            <ul class="col-sm-3 col-xs-3">
                <li><span class="span_width">调整的周：</span>
                    第 <input type="text" ng-model="newadjustcourse.odd_teachweek" id="odd_teachweek"
                             name="odd_teachweek" class="forminput"
                             style="width: 50px;margin-right: 10px;margin-left: 10px"/>周
                </li>
                <li>
                    <span class="span_width">调整的星期：</span>
                    <select type="text" ng-model="newadjustcourse.odd_week" name="odd_week" class="forminput"
                            id="odd_week"/>
                    <option value="">--请选择--</option>
                    <option value="1">星期一</option>
                    <option value="2">星期二</option>
                ...
                <li>
                    ...
                    <select type="text" ng-model="newadjustcourse.odd_pitch" name="odd_pitch" class="forminput"
                            id="odd_pitch"/>
                    <option value="">--请选择--</option>
                ...
                <li><span class="span_width">调整到周：</span>
                    第<input type="text" ng-model="newadjustcourse.now_teachweek" class="forminput"
                            style="width: 50px;margin-right: 10px;margin-left: 10px"/>周
                </li>
                <li>
                ...
                <li>
                    ...
                    <select type="text" ng-model="newadjustcourse.now_room" name="now_room" class="forminput"
                            id="now_room"/>
                    <option value="">--请选择--</option>
                    <option ng-repeat="usingClassRoom in usingClassRooms" value="{{usingClassRoom.classroomId}}">
                        {{usingClassRoom.classroomName}}
                    </option>
                    </select>
                </li>
                <li>
                    <span class="span_width">调整教师：</span>
                    <select ng-model="newadjustcourse.now_teachName" name="now_teachName" class="forminput"
                            id="now_teachName">
                        <option value="">--请选择--</option>
                        <option ng-repeat="option in options3" value="{{option.teacherId}}"
                                ng-bind="option.teacherName"></option>
                    </select>
                    </select>
                </li>
            </ul>
        ...
        <div class="row" style="margin-left: 60px">
            <ul class="col-sm-3 col-xs-3">
                <li><span class="span_width">停课周：</span>
                    第 <input type="text" ng-model="newadjustcourse.odd_teachweek" name="odd_teachweek" class="forminput"
                             style="width: 50px;margin-right: 10px;margin-left: 10px"/>周
                </li>
                <li>
...
<div class="table-courseshow">
    ...
    <div class="show">
        <ul style="margin-left: 200px">
            <li><span class="span_width">停课周：</span>
                第 <input type="text" ng-model="odd_teachweek" name="odd_teachweek" class="forminput"
                         style="width: 50px;margin-right: 10px;margin-left: 10px"/>周
            </li>
            <li>
                <span class="span_width">停课星期：</span>
    ...
    <table-btn class="bttn" ng-click="confirmstop()">确认</table-btn>
    <table-btn class="bttn" ng-click="close()">取消</table-btn>
</div>
<%--查看日志--%>
</body>
</html>
<script>
    ...
    var app = angular.module('app', []).controller('ctrl', function ($scope) {
        ...
        $scope.loadeducateTask = function () {
            ...
            remotecall("educateTaskcopy_load", {
                pageNum: pageNum,
                pageSize: pageSize,
                searchStr: searchStr,
                week1: $scope.week1,
...
//            week3=$("#week31").val();
            ...
            $(".pagingbox").show();
            $scope.show = 3;
            remotecall("basic_manualadjustcourse_load", {
                pageNum: pageNum,
                pageSize: pageSize,
                searchStr: searchStr,
                week1: $scope.week11,
