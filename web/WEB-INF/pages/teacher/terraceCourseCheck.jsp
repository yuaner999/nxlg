...
<div class="title">
    ...
    <select type="text" ng-model="majorName" name="majorName" class="forminput" id="majorName">
        <option value="" selected="selected">--请选择--</option>
        <option ng-repeat="major in majors" value="{{major.majorName}}" ng-bind="major.majorName"></option>
    </select>

    <span class="span_width">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级：</span>
    <select type="text" ng-model="ep_grade" name="ep_grade" class="forminput" id="ep_grade"/>
...
<script>
    ...
    var app = angular.module('app', []).controller('ctrl', function ($scope) {
        ...
        $scope.loadData = function () {
            ...
            loading();//加载
            remotecallasync("teacher_terraceCourseCheck_load_count", {
                filter: filter,
                pageNum: pageNum,
                pageSize: pageSize,
            ...
            //查询专业信息
            remotecallasync("teacher_educatePlan_college_major", {"v": "_major"}, function (data) {
                if (data.result) {
        ...
        $scope.showDetail = function (Info) {
            location.href = 'terraceCourseCheckMajor.form?college=' + encodeURI(Info.majorCollege) + "&major=" + encodeURI(Info.majorName) + "&grade=" + encodeURI(Info.gradeName);
        }
        //右侧菜单栏
