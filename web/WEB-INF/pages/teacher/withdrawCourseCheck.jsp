...
<!--筛选条件按钮组-->
<div class="title">
    <input class="tablesearchbtn" type="text" placeholder="请输入学生姓名搜索内容" onkeyup="getSearchStr(this)"/>
    ...
    var app = angular.module('app',[]).controller('ctrl',function  ($scope) {
        ...
        $scope.reject=function(tr){
            ...
            layer.prompt({
                ...
                remotecall("withdrawCourseCheck_reject",{studentId:$scope.dataitem.studentId,scc:scc,str:value},function (data) {
                    closeLoading();//关闭加载层
