...
<div class="title">
    <span  class="span_width">操作类型：</span>
    <select type="text" ng-model="checkType" name="checkType" class="forminput" id="checkType"/>
    ...
    <span  class="span_width">审核状态：</span>
    <select  type="text" ng-model="checkStatus" name="checkStatus" class="forminput"
            id="checkStatus"/>
    <option value="">--请选择--</option>
    ...
    <input class="tablesearchbtn" type="text" ng-model="majorName" placeholder="请输入专业名称" onkeyup="getSearchStr(this)"/>
...
<script>
    ...
    var app = angular.module('app', []).controller('ctrl', function ($scope) {
        ...
        $scope.loadData = function () {
            $scope.show = 1;
            loading();//加载
            remotecall("teacher_majorHandleLog_load", {
                pageNum: pageNum,
                pageSize: pageSize,
