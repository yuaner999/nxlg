...
function main(context) {
    ...
    var n= query(function () {/*
     ...
     LEFT JOIN stuchoosecourse ON (majorterracescore.`terraceId` = stuchoosecourse.`terraceId` AND student.`studentId`=stuchoosecourse.`studentId` AND stuchoosecourse.`pass`="已通过" AND iscomfirm='1' AND (scc_status!='退课通过' OR scc_status ='' OR ISNULL(scc_status)))
