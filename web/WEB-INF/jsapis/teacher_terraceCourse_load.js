...
function main(context) {
    ...
    var rr =querypagedata(function () {/*
     ...
     and case when ${filter} is not null and ${filter}<>"" and ${filter}="2" then `majorterracecourse`.mtc_checkStatus="未通过" else 1=1 end
     ...
     and case when ${checkStatus} is not null and ${checkStatus}<>""  then `majorterracecourse`.mtc_checkStatus = ${checkStatus} else 1=1 end
