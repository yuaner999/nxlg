...
function main(context) {
    ...
    var r=query(function () {/*
     ...
     where (iscomfirm='1' or iscomfirm='0') and stuchoosecourse.terraceId=${terraceId} and stuchoosecourse.studentId=${studentId} and term=${term} and majorName<>${studentMajor} and majorName<>${otherMajor} 
     */}, context,"");
