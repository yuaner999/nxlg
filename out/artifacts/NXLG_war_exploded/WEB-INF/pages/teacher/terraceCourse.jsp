...
<div class="title">
    ...
    <table-btn ng-show="show=='0'" id="search" ng-click="loadData()">搜索</table-btn>
...
<div class="tablebox" id="allInfo">
    <table class="table" style="table-layout:fixed">
        ...
        <tr ng-repeat="Info in allInfo">
            ...
            <td  ng-if="Var" ng-bind="Info.mtc_refuseReason" style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width: 100%"
...
<script>
    ...
    var app = angular.module('app',[]).controller('ctrl',function  ($scope) {
        ...
        $scope.loadData = function (){
            ...
            loading();//加载
            remotecallasync("teacher_terraceCourse_load",{filter:filter,pageNum:pageNum,pageSize:pageSize,searchStr:searchStr},function (data) {
                    closeLoading();//关闭加载层
        ...
        $scope.loadTerrace = function  (tr) {
            ...
            loading();//加载
            remotecall("teacher_terraceCourse_loadterrace","",function (data) {
                closeLoading();//关闭加载层
                $scope.terraces = data;
                //$scope.$apply();
                //数据为0时提示
        ...
        $scope.loadCourse = function  (tr) {
            ...
            loading();//加载
            remotecall("teacher_terraceCourse_loadEP",{pageNum:pageNum,pageSize:pageSize,majorCollege:$scope.majoritem.majorCollege,ep_major:$scope.majoritem.majorName,terraceName:$scope.terraceitem.terraceName},function (data) {
                closeLoading();//关闭加载层
