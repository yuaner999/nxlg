...
<div class="title">
    ...
    <div ng-show="show=='4'">
        ...
        <table-btn id="search" ng-click="loadCoursefirst()">搜索</table-btn>
...
<div class="tablebox" ng-if="show=='2'" id="s_course">
    ...
    <td><table-btn ng-click="withdraw(data)">退选</table-btn></td>
    </tr>
    </tbody>
    </table>
</div>
<div class="tablebox" id="major" ng-if="show=='5'">
    <table class="table">
        ...
        <tr ng-repeat="major in majors">
            ...
            <td><table-btn ng-click="loadTerrace(major)">选择</table-btn></td>
        </tr>
        </tbody>
    </table>
    <div class="pagingbox">
...
<div class="tablebox" ng-if="show=='3'" id="terrace">
    <table class="table">
        ...
        <tr ng-repeat="terrace in terraces">
            ...
            <td><table-btn ng-click="loadCoursefirst(terrace)">选择</table-btn></td>
        </tr>
        </tbody>
    </table>
</div>
...
//            console.log("第一个="+pageCount);
            loading();//加载
            remotecallasync("studentManage_loadStudent",{pageNum:pageNum,pageSize:pageSize,searchStr:searchStr},function (data) {
                closeLoading();
        ...
        $scope.loadCourse = function  (terrace) {
            ...
            remotecall("manualAdjustCourse_loadcourse",{majorId:majorId,studentGrade:studentGrade,terraceId:terraceId,pageNum:pageNum,pageSize:pageSize,keytname:keytname,keyroom:keyroom, keyunit:keyunit,keytime:keytime},function (data) {
                closeLoading();//关闭加载层
