...
<div class="title">
    ...
    <table-btn id="search" ng-if="show=='1'" ng-click="loadData()">搜索</table-btn>
...
<div class="table-show" id="detail">
    <img style="float: right; position:absolute; top:15px;right:15px" src="<%=request.getContextPath()%>/images/windowclose_03.jpg" ng-click="close()">
        ...
        <table-btn class="bttn" ng-click="modify()">选修该专业</table-btn><table-btn class="bttn" ng-click="other()">辅修该专业</table-btn>
        <div class="tips">
            <ul>
...
<div id="getScoreDetail" class="table-show">
    <div class="show">
        <img style="float: right; position:absolute; top:25px;right:15px" src="<%=request.getContextPath()%>/images/windowclose_03.jpg" ng-click="closeSele()">
...
<script>
    ...
    var app = angular.module('app',[]).controller('ctrl',function  ($scope) {
        ...
        $scope.loadData = function () {
            $scope.show=1;
            loading();//加载
            remotecall("teacher_majorList_load",{pageNum:pageNum,pageSize:pageSize,searchStr:searchStr},function (data) {
                closeLoading();
        ...
        $scope.educatePlan=function(tr,isfirst){
            ...
            loading();
            remotecall("teacher_majorList_loadeducatePlan",{ep_college:$scope.dataitem.majorCollege,ep_major:$scope.dataitem.majorName,pageNum:pageNum,pageSize:pageSize},function (data) {
                closeLoading();
...
//            searchStr="";
        ...
        $scope.getScore=function (data){
            $.ajax({url:baseurl+"stu_getscore.form",
                type:"POST",
        ...
        $scope.getOther = function(datas){
            ...
            oldPageNum=pageNum;
            pagenum=1;
            remotecall("getotherscore",{majorId:datas.majorId,pageNum:pageNum,pageSize:pageSize},function (data) {
                if(data.total==0){
                    parent.pMsg("暂无数据");
                }else {
        ...
        $scope.getfinish=function(data){
                ...
                $(".pagingbox").hide();
                loading();
                remotecall("basic_majorscore_load",{ep_college:data.majorCollege,ep_major:data.majorName},function (data) {
                    closeLoading();
                ...
                loading();
                remotecall("basic_classmajor_load",{ep_college:data.majorCollege,ep_major:data.majorName},function (data) {
                    closeLoading();
