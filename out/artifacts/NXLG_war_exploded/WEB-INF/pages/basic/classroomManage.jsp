...
<div class="table-addform container-fluid a-show">
    <img src="<%=request.getContextPath()%>/images/location.jpg" style="width:24px; margin-right: 8px;" />当前位置：教室管理 > 新增/修改
    <hr>
    <form id="AddForm">
        <div class="row">
            <ul class="col-sm-3 col-xs-3">
                <li>
                    ...
                    <select  ng-model="dataitem.campus" name="campus" class="forminput" id="campus" >
                        ...
                        <option ng-repeat="option in options_campus" value="{{option.wordbookValue}}" ng-bind="option.wordbookValue"></option>
                    </select>
                </li>
                <li>
                    <span>教学楼：</span>
                    <select  ng-model="dataitem.building" name="building" class="forminput" id="building" >
                        <option value="">--请选择--</option>
                        <option ng-repeat="option in options_building" value="{{option.wordbookValue}}" ng-bind="option.wordbookValue"></option>
                    </select>
                </li>
                <li><span>楼层：</span><input type="text"  ng-model="dataitem.floor" name="floor" class="forminput" id="floor"/></li>
                <li><span>教室号：</span><input type="text" ng-model="dataitem.classroomNum" name="classroomNum" class="forminput" id="classroomNum"/></li>
                <li><span>教室名称：</span><input type="text"  ng-model="dataitem.classroomName" name="classroomName" class="forminput" id="classroomName"/></li>
            </ul>
            <ul class="col-sm-3 col-xs-3">
                <li>
                    <span>教室类型：</span>
                    <select  ng-model="dataitem.classroomType" name="classroomType" class="forminput" id="classroomType" >
                        <option value="">--请选择--</option>
                        <option ng-repeat="option in options_classroomtype" value="{{option.crt_type}}" ng-bind="option.crt_type"></option>
                    </select>
                </li>
                <li><span>教室容量：</span><input type="text" ng-model="dataitem.classroomCapacity" name="classroomCapacity" class="forminput" id="classroomCapacity"/></li>
                <li><span>最小容积率：</span><input type="text" placeholder="请输入0-1之间2位小数" ng-blur="validate(dataitem.minCapacityRate)" ng-model="dataitem.minCapacityRate" name="minCapacityRate" class="forminput" id="minCapacityRate"/></li>
                <li><span>教室面积：</span><input type="text" ng-model="dataitem.classroomArea" name="classroomArea" class="forminput" id="classroomArea"/></li>
                <li>
                    <span>使用状态：</span>
                    <select  ng-model="dataitem.classroomStatus" name="classroomStatus" class="forminput" id="classroomStatus" >
                        <option value="">--请选择--</option>
                        <option value="使用" >使用</option>
                        <option value="停用" >停用</option>
                    </select>
                </li>
                <li><span>使用单位：</span><input type="text" ng-model="dataitem.classroomUnit" name="classroomUnit" class="forminput" id="classroomUnit"/></li>
            </ul>
        </div>
