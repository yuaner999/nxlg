...
<div class="title">
    ...
    <table-btn id="search" ng-click="loadStudent()">搜索</table-btn>
    ...
    <table class="table">
        ...
        <tr ng-repeat="student in students">
            <td class="thischecked" ng-click="thischecked(student)">
                <input  type="checkbox" id="kind" ng-model="student.td0" name="studentIdSelect" value="{{student.studentId}}"/>
            </td>
            ...
            <td><table-btn ng-click="edit(student)">修改</table-btn><b style="margin-right: 10px"></b><table-btn ng-click="del(student)">删除</table-btn></td>
        </tr>
        </tbody>
    </table>
</div>
...
<div class="table-addform container-fluid a-show">
    <img src="<%=request.getContextPath()%>/images/location.jpg" style="width:24px; margin-right: 8px;" />当前位置：学生管理 > 新增/修改
    <hr>
    <form id="Form">
        <div class="row">
            <br class="col-sm-3 col-xs-3">
                <li style="display: none;"><span>ID：</span><input type="text" ng-model="checkitem.studentId" name="studentId" class="forminput" id="studentId"/></li>
                <li><span class="span_width">学号：</span><input type="text" ng-model="checkitem.studentNum" name="studentNum" class="forminput" id="studentNum"/></li>
                <li><span class="span_width">姓名：</span><input type="text" ng-model="checkitem.studentName" name="studentName" class="forminput" id="studentName"/></li>
                <li><span class="span_width">姓名全拼：</span><input type="text" ng-model="checkitem.namePinYin" name="namePinYin" class="forminput" id="namePinYin"/></li>
                <li><span class="span_width">曾用名：</span><input type="text" ng-model="checkitem.usedName" name="usedName" class="forminput" id="usedName"/></li>
                <div class="photo">
                    <ul class="col-sm-3 col-xs-3">
                        <img src="<%=request.getContextPath()%>/images/icon_error.png"  id="PreView" style="margin-top:10px; width: 120px;height: 166px;"  name="studentIcon" id="studentIcon" ng-click="uploadIcon('#PreView')">
                    </ul>
                ...
                <li><span class="span_width">身份证号码：</span><input type="text" ng-model="checkitem.studentIDCard" name="studentIDCard" class="forminput" id="studentIDCard"/></li>
                <li>
                    <span class="span_width">性别：</span>
                    <select type="text" ng-model="checkitem.studentGender" name="studentGender" class="forminput" id="studentGender"/>
                ...
                <li><span class="span_width">出生日期：</span>
                    <input type="text" ng-model="checkitem.studentBirthday" name="studentBirthday" class="forminput" id="studentBirthday"/>
                </li>
                <li><span class="span_width">民族：</span><input type="text" ng-model="checkitem.studentNation" name="studentNation" class="forminput" id="studentNation"/></li>
                <li>
                    <span class="span_width">政治面貌：</span>
                    <select type="text" ng-model="checkitem.studentPolitics" name="studentPolitics" class="forminput" id="studentPolitics"/>
                        <option value="">--请选择--</option>
                ...
                <li><span class="span_width">手机：</span><input type="text" ng-model="checkitem.studentPhone" name="studentPhone" class="forminput" id="studentPhone"/></li>
                <li><span class="span_width">邮箱：</span><input type="text" ng-model="checkitem.studentEmail" name="studentEmail" class="forminput" id="studentEmail"/></li>
                <li><span class="span_width">其他联系人：</span><input type="text" ng-model="checkitem.linkMan" name="linkMan" class="forminput" id="linkMan"/></li>
                <li><span class="span_width">联系人电话：</span><input type="text" ng-model="checkitem.linkManPhone" name="linkManPhone" class="forminput" id="linkManPhone"/></li>
                <li><span class="span_width">联系地址：</span><input type="text" ng-model="checkitem.linkManaddress" name="linkManaddress" class="forminput" id="linkManaddress"/></li>
                <li><span class="span_width">联系人邮编：</span><input type="text" ng-model="checkitem.linkManPostcode" name="linkManPostcode" class="forminput" id="linkManPostcode"/></li>
                <li><span class="span_width">考号：</span><input type="text" ng-model="checkitem.examNumber" name="examNumber" class="forminput" id="examNumber"/></li>
                <li><span class="span_width">高考所在省：</span><input type="text" ng-model="checkitem.province" name="province" class="forminput" id="province"/></li>
                <li><span class="span_width">毕业中学：</span><input type="text" ng-model="checkitem.highSchool" name="highSchool" class="forminput" id="highSchool"/></li>
                <li><span class="span_width">入学日期：</span><input type="text" ng-model="checkitem.entranceDate" name="entranceDate" class="forminput" id="entranceDate"/></li>
                <li>
                    <span class="span_width">年级：</span>
                    <select type="text" ng-model="checkitem.studentGrade" name="studentGrade" class="forminput" id="studentGrade" ng-change="loadClass()">
                ...
                <li>
                    ...
                    <select type="text" ng-model="checkitem.studentCollege" name="studentCollege" class="forminput" id=studentCollege" ng-change="loadMajor(this)">
                        <option value="" selected="selected">--请选择--</option>
                        <option ng-repeat="college in colleges" value="{{college.wordbookValue}}" ng-bind="college.wordbookValue"></option>
                    </select>
                </li>
                <li>
                    <span class="span_width">专业：</span>
                    <select type="text" ng-model="checkitem.studentMajor" name="studentMajor" class="forminput" id=studentMajor" >
                        <option value="" selected="selected">--请选择--</option>
                        <option ng-repeat="major in majors" value="{{major.majorName}}" ng-bind="major.majorName"></option>
                    </select>
                    <%--<input type="text" />--%>
                </li>
                <li><span class="span_width">辅修：</span><input type="text" ng-model="checkitem.otherMajor" name="otherMajor" class="forminput" id="otherMajor"/></li>
                <li><span class="span_width">班级：</span>
                    ...
                    <select type="text" ng-model="checkitem.studentClass" name="studentClass" class="forminput" id="studentClass">
                        <option value="" selected="selected">--请选择--</option>
                        <option ng-repeat="class in newClasses" value="{{class.className}}" ng-bind="class.className"></option>
                    </select>
                </li>
                <li>
                    <span class="span_width">培养层次：</span>
                    <select type="text" ng-model="checkitem.studentLevel" name="studentLevel" class="forminput" id="studentLevel"/>
                        <option value="">--请选择--</option>
                ...
                <li>
                    ...
                    <select type="text" ng-model="checkitem.studentLength" name="studentLength" class="forminput" id="studentLength"/>
                        <option value="">--请选择--</option>
                ...
                <li>
                    ...
                    <select type="text" ng-model="checkitem.studentForm" name="studentForm" class="forminput" id="studentForm"/>
                        <option value="" selected="selected">--请选择--</option>
                ...
                <li>
                    ...
                    <select type="text" ng-model="checkitem.studentSchoolAddress" name="studentSchoolAddress" class="forminput"id="studentSchoolAddress">
                        <option value="" selected="selected">--请选择--</option>
                        <option ng-repeat="option in options" value="{{option.wordbookValue}}" ng-bind="option.wordbookValue"></option>
                    </select>
                </li>
        </div>
