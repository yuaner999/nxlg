...
<div class="title">
    <table-btn ng-if="show=='0'" class="top_1" ng-click="addfirst()"><img src="<%=request.getContextPath()%>/images/tableadd_07.png" />新建</table-btn>
    <table-btn ng-if="show=='0'" ng-click="deletes()"><img src="<%=request.getContextPath()%>/images/tabledelete_07.png" />批量删除</table-btn>
    ...
    <table-btn ng-if="show=='0'" id="search" ng-click="loadData()">搜索</table-btn>
    ...
    <table-btn ng-if="show=='3'" ng-click="previous3()">返回编辑</table-btn>
...
<div class="tablebox" ng-if="show=='0'">
    <table class="table"  style="table-layout:fixed">
        ...
        <th>审核状态</th>
        <th class="top_2" style="display:none">未通过原因</th>
        ...
        <tr ng-repeat="teachtask in teachtasks">
            ...
            <td><table-btn ng-click="showmajor(teachtask)">查看</table-btn></td>
            <td class="top_2" style="display:none" ng-bind="teachtask.tc_checkType"></td>
            <td ng-bind="teachtask.tc_checkStatus"></td>
            <td class="top_2 Ar" style="display:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width: 100%" ng-bind="teachtask.tc_refuseReason"
                ng-click="ReasonDetail(teachtask.tc_refuseReason,$index)"></td>
            <td><table-btn class="top_1" ng-click="edit(teachtask)">修改</table-btn>&nbsp&nbsp<table-btn ng-click="delete(teachtask)">删除</table-btn></td>
        </tr>
        </tbody>
    </table>
</div>
<div class="tablebox" ng-if="show=='1'">
    <table class="table">
        ...
        <tr ng-repeat="Info in allInfo">
            ...
            <td><table-btn ng-click="detail(Info)">详情</table-btn></td>
        </tr>
        </tbody>
    </table>
</div>
<div class="tablebox" ng-if="show=='2'">
    <table class="table">
        ...
        <tr ng-repeat="Info in allInfo2">
            ...
            <td><table-btn ng-click="stunum(Info)">详情</table-btn></td>
        </tr>
        </tbody>
    </table>
</div>
...
<div class="table-addform container-fluid a-show">
    <form id="Form">
        <div class="row">
            ...
            <li><span class="span_width">所分班级：</span><input type="text" ng-model="checkitem.tc_class" name="tc_class" class="forminput" id="tc_class"/></li>
            <li><span class="span_width">班级教师：</span>
                <select  ng-model="checkitem.tc_classteacherid" name="tc_classteacherid" class="forminput" id="tc_classteacherid">
                    <option value="">--请选择--</option>
                    <option ng-repeat="option in checkitem.b" value="{{option.bteacherId}}" ng-bind="option.bteacherName"></option>
                </select>
            </li>
            <li>
                <span class="span_width">班级最小人数：</span>
                <input style="" type="text" ng-model="checkitem.tc_studentnum" name="tc_studentnum" class="forminput" id="tc_studentnum"/>
            </li>
            <li>
                <span class="span_width">班级最大人数：</span>
                <input style="" type="text" ng-model="checkitem.tc_numrange" name="tc_numrange" class="forminput" id="tc_numrange"/>
            </li>
            <li>
                ...
                <select ng-model="checkitem.tc_teachway" name="tc_teachway" class="forminput" id="tc_teachway">
                    <option value="">--请选择--</option>
                    <option ng-repeat="option in options4" value="{{option.crt_type}}" ng-bind="option.crt_type"></option>
                </select>
            </li>
            </ul>
            <ul class="col-sm-3 col-xs-3 col">
            <li><span class="span_width">授课周时：</span>
                <input type="text" ng-model="checkitem.tc_thweek_start" name="tc_thweek_start" class="forminput1" id="tc_thweek_start"/>至
                <input type="text" ng-model="checkitem.tc_thweek_end" name="tc_thweek_end" class="forminput1" id="tc_thweek_end"/>
            </li><br>
            ...
            <li><span class="span_width">先行课程：</span>
                <select  ng-model="checkitem.tc_teachmore" name="tc_teachmore" class="forminput" id="tc_teachmore" ng-click="teachmore()">
                    <option value="">--请选择--</option>
                    <option ng-repeat="option in options1" value="{{option.chineseName}}" ng-bind="option.chineseName"></option>
                </select>
            </li>
...
<script>
    ...
    var app = angular.module('app',[]).controller('ctrl',function  ($scope) {
        ...
        $scope.loadData = function () {
            ...
            remotecall("educateTask_load",{pageNum:pageNum,pageSize:pageSize,filter:filter,searchStr:searchStr},function (data) {
                closeLoading();//关闭加载层
        ...
        $("#Form").validate({
                            ...
                            if(data){
                                remotecallasync("educateTask_edit", $scope.checkitem, function (data) {
                                    ...
                                    if(data==1){
                                        ...
                                        closeLoading();//关闭加载层
                                        if($scope.tMajors.length>0){
                                            remotecall("educateTask_editmajor",{tc_id:data.tc_id,tc_checkStatus:$scope.checkitem.tc_checkStatus,tMajors:$scope.tMajors},function (data) {
                                                if(!data){
            ...
            messages:{
                ...
                tc_studentnum:{required:"请输入最小班级人数",
                    digits: "只能输入数字"},
                tc_numrange:{
                    required:"请输入最大班级人数",
                    digits: "只能输入数字"
...
//            }
        ...
        $scope.setmajor=function(){
            ...
            remotecall("educateTask_loadM",{pageNum:pageNum,pageSize:pageSize,cour:cour},function (data) {
                closeLoading();
        ...
        $scope.deletes = function () {
            ...
            console.log( $scope.checkitem.length);
            loading();//加载层
