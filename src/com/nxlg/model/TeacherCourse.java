...
public class TeacherCourse {
    ...
    private int weekend;
    private int IsSingleDoubleWeek;  //单双周 0：非单双周  1：单周  2：双周
    private String specialtyId;   //所属专业

    public TeacherCourse() {
    }

    public TeacherCourse(String dbTeCoId, String dbTeacherId, String dbCourseId, int dbstuNum, String section, String roomType, int weekhours, int weekstart, int weekend, int IsSingleDoubleWeek, String specialtyId) {
    ...
    public void setIsSingleDoubleWeek(int isSingleDoubleWeek) {
        IsSingleDoubleWeek = isSingleDoubleWeek;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (IsSingleDoubleWeek != that.IsSingleDoubleWeek) return false;
