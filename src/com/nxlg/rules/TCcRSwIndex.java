...
public class TCcRSwIndex implements ITCcRSwIndex {
    ...
    public void setTeacherCourseSet(Set<Integer> teacherCourseSet) {
    ...
    public void setRoomSet(Set<Integer> roomSet) {
        this.roomSet = roomSet;
    }

    public Set<Integer> getTeacherCourseSet() {
    ...
    @Override
    public void registDbTeacherCourse(String dbTeCoId, String dbTeacherId, String dbCourseId, int dbstuNum, String section, String roomType, int weekhours, int weekstart, int weekend, int IsSingleDoubleWeek, String specialtyId) {
        dbTeacherCourseSet.add(new TeacherCourse(dbTeCoId, dbTeacherId, dbCourseId, dbstuNum, section, roomType, weekhours, weekstart, weekend, IsSingleDoubleWeek, specialtyId));
    }

    @Override
    public void buildTeachCourseIndex() {
    ...
    public int getRoomIdByDbRoomId(String dbRoomId) {
        int roomId = 0;
        for (Map.Entry<Room, Integer> entry : db_ga_roomMap.entrySet()) {
            if(Objects.equals(entry.getKey().getDbRoomId(),dbRoomId)) roomId = entry.getValue();
        }
        return roomId;
    }
